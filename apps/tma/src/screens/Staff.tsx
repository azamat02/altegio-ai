...
export function StaffList({ rows, onOpen }: {
...
export function Staff() {
  ...
  if (detailId !== null) {
    return <StaffDetailScreen staffId={detailId} period={period} onBack={() => setDetailId(null)} />;
  }
  ...
  return (
    <div className="stack">
      ...
      <StaffList rows={rows} onOpen={setDetailId} />
    </div>
  );
}
